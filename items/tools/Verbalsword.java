...
public class Verbalsword extends ItemSword {

	public Verbalsword(int id, EnumToolMaterial toolMaterial) {
		super( id, toolMaterial);
		this.setCreativeTab(moreofeverything.moreofeverythingTools);
		setMaxStackSize(1);
		this.setUnlocalizedName(Names.Verbalsword_unlocalizedName);
	}
	...
	public void registerIcons(IconRegister icon) {
		...
		itemIcon = icon.registerIcon(ModInfo.ID.toLowerCase() + ":"
				+ Names.Verbalsword_unlocalizedName);
