...
public class Verbalshovel extends ItemSpade {
	public Verbalshovel(int id, EnumToolMaterial toolMaterial) {
		super(id, toolMaterial);
		this.setCreativeTab(moreofeverything.moreofeverythingTools);
		setMaxStackSize(1);
		this.setUnlocalizedName(Names.Verbalshovel_unlocalizedName);
	}
	...
	public void registerIcons(IconRegister icon) {
		...
		itemIcon = icon.registerIcon(ModInfo.ID.toLowerCase() + ":"
				+ Names.Verbalshovel_unlocalizedName);
