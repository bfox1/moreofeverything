...
public class Scikaleaxe extends ItemAxe {

	public Scikaleaxe(int id, EnumToolMaterial toolMaterial) {
		super(id, toolMaterial);
		this.setCreativeTab(moreofeverything.moreofeverythingTools);
		setMaxStackSize(1);
		this.setUnlocalizedName(Names.Scikaleaxe_unlocalizedName);
	}
	...
	public void registerIcons(IconRegister icon) {
		...
		itemIcon = icon.registerIcon(ModInfo.ID.toLowerCase() + ":"
				+ Names.Scikaleaxe_unlocalizedName);
